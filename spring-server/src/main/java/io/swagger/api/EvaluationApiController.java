...
public class EvaluationApiController implements EvaluationApi {
    ...
    public ResponseEntity<Void> addEvaluation(@ApiParam(value = "evaluation object that needs to be added to the db" ,required=true )  @Valid @RequestBody Evaluation body) {
    ...
    public ResponseEntity<DepositInformation> getEvaluation(@ApiParam(value = "information of a user to return",required=true) @PathVariable("month") Integer month,@ApiParam(value = "information of a user to return",required=true) @PathVariable("year") String year,@ApiParam(value = "information of a user to return",required=true) @PathVariable("manager_id") String managerId) {
        String accept = request.getHeader("Accept");
